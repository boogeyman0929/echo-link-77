    ...
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 max-w-[640px] mx-auto px-5 py-12 md:py-20">
        ...
        <motion.div
          ...
          style={{ boxShadow: '0 0 80px -30px hsl(310 50% 50% / 0.08)' }}
        >
          <div className="flex items-center gap-5">
            <div className="relative">
              <img
                ...
                alt="suicidal"
                className="w-20 h-20 rounded-full object-cover border border-[hsl(310,50%,50%,0.2)]"
              />
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            <div className="w-2 h-2 rounded-full" style={{ background: 'hsl(310 50% 50%)' }} />
            <span className="text-xs uppercase tracking-widest text-muted-foreground">presence</span>
          </div>
          <div className="grid grid-cols-2 gap-4">
            <div className="p-4 rounded-xl border border-border/30" style={{ background: 'hsl(0 0% 4%)' }}>
              <p className="text-[10px] uppercase tracking-wider text-muted-foreground mb-1">status</p>
              <p className="text-sm text-foreground">online</p>
            </div>
            <div className="p-4 rounded-xl border border-border/30" style={{ background: 'hsl(0 0% 4%)' }}>
              <p className="text-[10px] uppercase tracking-wider text-muted-foreground mb-1">mood</p>
              <p className="text-sm text-foreground">void</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          <h3 className="text-xs uppercase tracking-widest text-muted-foreground mb-4 px-1">Socials</h3>
